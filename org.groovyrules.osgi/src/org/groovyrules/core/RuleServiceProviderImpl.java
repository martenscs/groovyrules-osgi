...
/**
 * Implementation of <tt>RuleServiceProvider</tt>. This is used to retrieve the
 * <tt>RuleAdministrator</tt> and <tt>RuleRuntime</tt>.
 * <p>
 ...
 * </pre>
 * 
 * Note that the above example shows retrieving the default file-based rule
 * service provider - the following URIs can be passed to the
...
public class RuleServiceProviderImpl extends javax.rules.RuleServiceProvider {
	...
	public static final String RULE_IMPL_CLASSLOADER = "org.groovyrules.core.HostClassloader";
	public static final Object RULE_IMPL_BUNDLE = "BUNDLE";
	static {
		try {
			RuleServiceProviderManager.registerRuleServiceProvider(
					FILE_RULE_SERVICE_PROVIDER_URI,
					RuleServiceProviderImpl.class);
			RuleServiceProviderManager.registerRuleServiceProvider(
					DIRECT_RULE_SERVICE_PROVIDER_URI,
					DirectRuleServiceProviderImpl.class);
